...
public class ExistsException extends ApplicationException {
  ...
  public enum ExistsExceptionType implements ExceptionType {
    ...
    DOMICILIATION_ALREADY_EXISTS(
        "error.server.exists.domiciliation-already-exists.title",
        "error.server.exists.domiciliation-already-exists.msg",
        "Domiciliation already exists"),
